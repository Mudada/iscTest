...
/* package iscTest-0.1.0.0 */
#define VERSION_iscTest "0.1.0.0"
#define MIN_VERSION_iscTest(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "iscTest-0.1.0.0-2cgyLH1x5y5EfCuMCEHlUu"

#define CURRENT_PACKAGE_KEY "iscTest-0.1.0.0-2cgyLH1x5y5EfCuMCEHlUu"
